...
function showResults() {
  ...
  // Participation message and dynamic image selection
  let message = "";
  let imageURL = ""; // Placeholder for static image URLs

  if (score === maxQuestions) {
    message = "Excellent! You answered all questions correctly!";
     // Replace with your static image
...
startBtn.addEventListener("click", async () => {
  ...
  score = 0;
  scoreElement.textContent = `Score: ${score}`;
  timerElement.textContent = `Time: ${String(
    Math.floor(timeLimit / 60)
  ).padStart(2, "0")}:${String(timeLimit % 60).padStart(2, "0")}`;
